...
$(document).ready(function () {
    var AUTH0_CLIENT_ID = $('#auth0').data('client-id');
    var AUTH0_DOMAIN = $('#auth0').data('domain');
    var AUTH0_CALLBACK_URL = $('#auth0').data('callback-url');
    var errorMsg = $('#auth0').data('error-msg');

    // svg definition for the mozilla logo
    ...
    var options = {
        // display the mozilla logo on the lock screen by default
        icon: 'data:image/svg+xml;base64,' + window.btoa(logo),
        primaryColor: '#d7d3c8',
        dict: {title: ''},
        // the supported social connection
    ...
    $('#signin-link').click(function () {
        // show the lock screen for login
