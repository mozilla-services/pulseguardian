...
if not flask_server_name:
    ...
    flask_server_name = "{}{}".format(flask_host, flask_port_spec)
...
# Database
database_url = os.getenv("DATABASE_URL", "postgresql://root@localhost/pulseguardian")
...
# Management API URL.
rabbit_management_url = os.getenv(
    "RABBIT_MANAGEMENT_URL", "http://localhost:15672/api/"
)
